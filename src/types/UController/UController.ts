...
export class GenericAction extends EthereumEvent {
  get params(): GenericActionParams {
    return new GenericActionParams(this);
  }
}

export class GenericActionParams {
  _event: GenericAction;

  constructor(event: GenericAction) {
    this._event = event;
  }
...
export class SendEther extends EthereumEvent {
  get params(): SendEtherParams {
    return new SendEtherParams(this);
  }
}

export class SendEtherParams {
  _event: SendEther;
...
export class ExternalTokenTransfer extends EthereumEvent {
  get params(): ExternalTokenTransferParams {
    return new ExternalTokenTransferParams(this);
  }
}

export class ExternalTokenTransferParams {
...
export class ExternalTokenTransferFrom extends EthereumEvent {
  get params(): ExternalTokenTransferFromParams {
    return new ExternalTokenTransferFromParams(this);
  }
}

export class ExternalTokenTransferFromParams {
...
export class ExternalTokenIncreaseApproval extends EthereumEvent {
  get params(): ExternalTokenIncreaseApprovalParams {
    return new ExternalTokenIncreaseApprovalParams(this);
  }
}

export class ExternalTokenIncreaseApprovalParams {
  _event: ExternalTokenIncreaseApproval;

  constructor(event: ExternalTokenIncreaseApproval) {
    this._event = event;
  }
...
export class ExternalTokenDecreaseApproval extends EthereumEvent {
  get params(): ExternalTokenDecreaseApprovalParams {
    return new ExternalTokenDecreaseApprovalParams(this);
  }
}

export class ExternalTokenDecreaseApprovalParams {
  _event: ExternalTokenDecreaseApproval;

  constructor(event: ExternalTokenDecreaseApproval) {
    this._event = event;
  }
...
export class GenericCall extends EthereumEvent {
  get params(): GenericCallParams {
    return new GenericCallParams(this);
  }
}

export class GenericCallParams {
  _event: GenericCall;
