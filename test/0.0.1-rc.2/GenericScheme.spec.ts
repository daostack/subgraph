...
const ActionMock = require('@daostack/migration-experimental/contracts/0.0.1-rc.2/ActionMock.json');
const GenericScheme = require('@daostack/migration-experimental/contracts/0.0.1-rc.2/GenericScheme.json');
