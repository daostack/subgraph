...
const ActionMock = require('@daostack/migration-experimental/contracts/0.1.1-rc.10/ActionMock.json');
const GenericScheme = require('@daostack/migration-experimental/contracts/0.1.1-rc.10/GenericScheme.json');
