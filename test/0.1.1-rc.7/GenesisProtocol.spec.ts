...
const ContributionReward = require('@daostack/migration-experimental/contracts/0.1.1-rc.7/ContributionReward.json');
const DAOToken = require('@daostack/migration-experimental/contracts/0.1.1-rc.7/DAOToken.json');
