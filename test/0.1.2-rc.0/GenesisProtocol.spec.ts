...
const ContributionReward = require('@daostack/migration-experimental/contracts/0.1.2-rc.4/ContributionReward.json');
const DAOToken = require('@daostack/migration-experimental/contracts/0.1.2-rc.4/DAOToken.json');
